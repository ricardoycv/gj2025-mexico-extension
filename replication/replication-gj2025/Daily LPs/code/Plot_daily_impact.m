...
function Plot_daily_impact(irfsdatapath,filename,figurepath,shockvar,savename,lagtoplot,samexaxis)
...
irs_label = [{'tb_rate_3m'},{'3M-TB rate (pp)'};...
    {'tb_rate_1y'},{'1Y-TB rate (pp)'};...
    {'tb_rate_2y'},{'2Y-TB rate (pp)'};...
    {'tb_rate_5y'},{'5Y-TB rate (pp)'};...
    {'tb_rate_10y'},{'10Y-TB rate (pp)'}];
ecs_label = [{'ectreas_1y_us'},{'1Y-EC (pp)'};...
    {'ectreas_2y_us'},{'2Y-EC (pp)'};...
    {'ectreas_5y_us'},{'5Y-EC (pp)'};...
    {'ectreas_10y_us'},{'10Y-EC (pp)'}];
tps_label = [{'tptreas_2y_us'},{'2Y-TP (pp)'};...
    {'tptreas_5y_us'},{'5Y-TP (pp)'};...
    {'tptreas_10y_us'},{'10Y-TP (pp)'}];
