...
X = [const, trend, Dunemp1(i:j), DGDP1(i:j), Dcpi1(i:j), ...
           mthlyunemp0(i:j), mthlynfp0(i:j), mthlygdp(i-1:j-1), ...
...
nms = ["Constant", "Trend", "BC unemp FC rev", "BC GDP FC rev", "BC CPI FC rev", "unemp news", "payroll news", ...
         "GDP news", "6m chg core CPI", "exp core CPI", "core CPI news", "SP500 ret up to beg of mth", "SP500 ret since beg of mth", ...
